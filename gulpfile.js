...
var taskFns = {
  ...
  appCSS: function () {
    ...
    gulp
      .src([
        "./app/**/*.css",
        "!./app/vendor/xgplayer-skin-default.css",
      ])
...
gulp.task("copy-vendor-player", function (cb) {
  ...
  fs.copyFileSync(
      "./node_modules/xgplayer/dist/index.js",
      dest + "/xgplayer.js"
  );
  fs.copyFileSync(
      "./node_modules/xgplayer-flv.js/dist/index.js",
      dest + "/xgplayer-flv.js"
  );
  fs.copyFileSync(
      "./app/vendor/xgplayer-skin-default.css",
      dest + "/xgplayer-skin-default.css"
  );
  cb();
});
...
gulp.task("gen-package", ["copy-index"], function () {
  return gulp.src(["./package.json"]).on("end", function (cb) {
    ...
    exec("cd dist && npm install --production", cb);
  });
});
...
gulp.task("watch", function () {
  ...
  gulp.watch(["./node/i18n/*.js"], ["copy-i18n"]);
  gulp.watch(["./node/**", "!./node/i18n/**"], ["copy-node"]);
});
