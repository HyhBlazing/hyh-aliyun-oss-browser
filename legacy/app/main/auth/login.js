angular.module("web").controller("loginCtrl", [
  ...
  function (
    ...
    function showAkHistory() {
      $modal
        .open({
          templateUrl: "main/auth/modals/ak-history-modal.html",
          controller: "akHistoryModalCtrl",
          size: "md",
          windowClass: "ak-history-modal-window",
          backdrop: "static",
        })
