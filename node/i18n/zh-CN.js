module.exports = {
  ...
  "auth.akHistories.hint": "点击记录或「使用」按钮可填充登录表单",
  "auth.akHistories.descSaved": "备注已保存",
  "auth.secure": "HTTPS加密",
  ...
  "bookmark.remove.success": "已取消收藏",
  "bookmark.add.error1": "添加收藏失败: 超过最大限制",
  "bookmark.add.error2": "只能收藏文件夹",
  "bookmark.add.success": "添加收藏成功",
  ...
  "settings.showSaveAsHome": "显示设为首页",
  "settings.showSaveAsHome.msg":
    "在地址栏显示「保存为首页」按钮，可将当前路径设为启动首页",
  ...
  //bookmark
  "bookmarks.title": "收藏管理",
  time: "时间",
  "bookmarks.delete.success": "删除收藏成功",
